...
const EquipmentGatePassOUTView = () => {
  ...
  return (
    <div className="EquipmentGatePassOUTView-container">
      <div className="EquipmentGatePassOUTView-addBtn">
        <button className="EquipmentGatePassOUTView-add-button" onClick={openPopup}>
          + Add New Equipment GatePass OUT View
        </button>
      </div>

      <div className="EquipmentGatePassOUTView-search-N-result">
        <div className="EquipmentGatePassOUTView-search-bar">
        ...
        <div className="EquipmentGatePassOUTView-results-info">
          <span>
            Showing {filteredBreakDownDetails.length} / {breakDownDetails.length} results
          </span>
          <button
            className="EquipmentGatePassOUTView-print-button"
      ...
      <div className="EquipmentGatePassOUTView-table-container">
        <table ref={tableRef}>
          <thead>
            <tr>
              {[
