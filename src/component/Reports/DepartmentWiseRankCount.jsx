...
const DepartmentWiseRankCountCom = () => {
  ...
  return (
    <div className="user-collection-report">
      ...
      <div className="user-collection-report-filters">
          ...
          <select >
            <option value="">Select DepartmentName</option>
            
          </select>


          
          <button className="user-collection-report-show-btn" onClick={handleShowReport}>Load</button>
...
export default DepartmentWiseRankCountCom;
