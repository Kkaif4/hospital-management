...
function QueryPageInventory() {
  ...
  const [userMsg, setUserMessage] = useState(location.state?.userMsg || '');
  ...
  const handleAction = async (actionType) => {
    try {
      ...
      const response = await axios.put(`http://localhost:8085/api/super/inventories/${userId}`, formData);
...
export default QueryPageInventory;
